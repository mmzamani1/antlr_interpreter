...
public class NotSimpleCalcLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"MULT", "DIV", "PLUS", "MINUS", "PWR", "REM", "EQ", "LT", "GT", "LE", 
			"GE", "DE", "NE", "NO", "Identifier", "Number", "StringLiteral", "WS", 
			"NEWLINE"
		};
	}
	...
	public NotSimpleCalcLexer(CharStream input) {
		super(input);
